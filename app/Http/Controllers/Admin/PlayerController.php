...
class PlayerController extends Controller
{
    //
    use ResponseTrait;
    private $view_path = 'Admin.CRUDS.players.';

    protected $permission = 'players';
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $admins = Player::with('club','city','country')->latest();
            return DataTables::of($admins)
                ...
                ->editColumn('title', function ($admin) {
                    ...
                    return $admin->club ? $admin->club->title : 'N/A';
