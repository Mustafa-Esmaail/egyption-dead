...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('team-players.store')}}">
    @csrf
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
               ...
               <!--end::Label-->
               <input type="number" name="number" value="" id="number" required class="form-control form-control-solid"
                      placeholder=""  />
        </div>
