<div class="modal fade" data-bs-backdrop="static"  id="Modal" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        @php 
        $modal_with = isset($modalWidth) ? $modalWidth : 'modal-xl';
        @endphp
        <div class="modal-dialog modal-dialog-centered {{$modal_with}}">
            <!--begin::Modal content-->
            <div class="modal-content" id="modalContent">
                <!--begin::Modal header-->
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> {{helperTrans("admin.$pageName")}} </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
