...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('admin.updateprofile')}}">
    @csrf
    ...
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="text" required class="form-control form-controlsolid" placeholder=" " name="first_name"
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input required type="text" class="form-control form-controlsolid" placeholder="" name="last_name" value="{{$admin->last_name}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="email" required class="form-control form-controlsolid"
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="phone" type="text" class="form-control form-controlsolid " placeholder=" " name="phone"
                   value="{{$admin->phone}}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input type="password" class="form-control form-controlsolid " placeholder="  " name="password"
                   value=""/>
        </div>
    ...
    <div class="d-flex flex-column mb-7 fv-row col-sm-6 justify-content-right">
        <button  type="submit" class="btn btn-primary col-2 float-right">
