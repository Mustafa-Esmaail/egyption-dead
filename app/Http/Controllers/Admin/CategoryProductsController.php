...
class CategoryProductsController extends Controller
{
    ...
    private $view_path = 'Admin.CRUDS.categoryProducts.';

    protected $permission = 'categoryProducts';
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $admins = CategoryProduct::query()->latest();
            return DataTables::of($admins)
                ->addColumn('action', function ($admin) {
                    ...
                    if (!auth('admin')->user()->can('edit categoryProducts'))
                        $edit = 'hidden';
                    if (!auth('admin')->user()->can('delete categoryProducts'))
                        $delete = 'hidden';
                    return '
    ...
    public function store(Request $request)
    {
        try{
            ...
            $row = CategoryProduct::create($data);
    ...
    public function edit($id)
    {
        ...
        $row=CategoryProduct::findOrFail($id);
